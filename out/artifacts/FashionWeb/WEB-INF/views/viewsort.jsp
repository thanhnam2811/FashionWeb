...
<section class="bg0 p-t-23 p-b-140">
    <div class="container">
        ...
        <div class="flex-c-m flex-w w-full p-t-45">
            <a href="${pageContext.request.contextPath}/SapXep?sort=${sort == null ? 'ASC': sort}&minvalue=${minvalue == null ? 0: minvalue}&maxvalue=${maxvalue}&page=${page == totalpage ? page: page+1}"
            ...
            <div class="flex">
                <ul>
                    <c:forEach var="p" begin="1" end="${totalpage}">
                        <li><a href="${pageContext.request.contextPath}/SapXep?sort=${sort == null ? 'ASC': sort}&minvalue=${minvalue == null ? 0: minvalue}&maxvalue=${maxvalue}&page=${p}"
                               class="${p == page ?"active":""}">${p}</a></li>
                    </c:forEach>
                    <div class="bar"></div>
                </ul>
            </div>
