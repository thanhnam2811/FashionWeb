...
insert into LoaiSP(tenLoaiSP) values(N'Giày')

-- ThuongHieu
insert into ThuongHieu(tenTH, emailTH) values('Adidas', N'adidas@gmail.com')
insert into ThuongHieu(tenTH, emailTH) values('Nike', N'nike@gmail.com')
insert into ThuongHieu(tenTH, emailTH) values('Biti''s', N'bitis@gmail.com')
insert into ThuongHieu(tenTH, emailTH) values('POLO', N'polo@gmail.com')
insert into ThuongHieu(tenTH, emailTH) values('puma', N'puma@gmail.com')
insert into ThuongHieu(tenTH, emailTH) values('Gucci', N'Gucci@gmail.com')

-- VanChuyen
insert into VanChuyen(tenDV, email, SDT, diaChi) values('J&T Express', N'J&T@gmail.com', '0911111111', N'TP.HCM')
...
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(1, 12, 3)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(1, 14, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(1, 16, 2)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(1, 18, 1)

insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(2, 11, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(2, 13, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(2, 17, 4)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(2, 19, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(2, 9, 2)

insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(3, 1, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(3, 3, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(3, 7, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(3, 9, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(3, 11, 2)

insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(4, 2, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(4, 4, 2)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(4, 6, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(4, 8, 1)
insert into ChiTietGioHang(maKH, maSP, soLuongSP) values(4, 10, 2)

-- DonHang
insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(1, 1, 'Nam', 'Ba Tri', '091771024')
insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(1, 1, 'Nam', 'Ba Tri', '091771024')

insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(2, 3, 'Nam', 'Ba Tri', '091771024')
insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(2, 1, 'Nam', 'Ba Tri', '091771024')

insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(3, 1, 'Nam', 'Ba Tri', '091771024')
insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(3, 2, 'Nam', 'Ba Tri', '091771024')

insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(4, 3, 'Nam', 'Ba Tri', '091771024')
insert into DonHang(maKH, maDV, tenNguoiNhan, diaChi, sdt) values(4, 1, 'Nam', 'Ba Tri', '091771024')

-- ChiTietDonHang

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(1, 10, 1)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(1, 2, 1)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(2, 12, 3)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(2, 2, 3)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(3, 11, 1)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(3, 1, 1)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(4, 13, 1)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(4, 3, 1)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(5, 1, 1)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(5, 10, 1)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(6, 3, 1)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(6, 7, 1)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(7, 2, 1)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(7, 5, 1)

insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(8, 4, 2)
insert into ChiTietDonHang(maDH, maSP, soLuongSP) values(8, 14, 2)

-- BinhLuan
insert into BinhLuan(maKH, maSP, noiDung) values(1, 1, N'Sản phẩm quá tuyệt vời')
insert into BinhLuan(maKH, maSP, noiDung) values(1, 2, N'Sản phẩm quá tuyệt vời')

insert into BinhLuan(maKH, maSP, noiDung) values(2, 3, N'Sản phẩm quá tuyệt vời')
insert into BinhLuan(maKH, maSP, noiDung) values(2, 4, N'Sản phẩm quá tuyệt vời')

insert into BinhLuan(maKH, maSP, noiDung) values(3, 5, N'Sản phẩm quá tuyệt vời')
insert into BinhLuan(maKH, maSP, noiDung) values(3, 6, N'Sản phẩm quá tuyệt vời')

insert into BinhLuan(maKH, maSP, noiDung) values(4, 7, N'Sản phẩm quá tuyệt vời')
insert into BinhLuan(maKH, maSP, noiDung) values(4, 8, N'Sản phẩm quá tuyệt vời')
