...
-- ThuongHieu
insert into ThuongHieu(tenTH, emailTH)
values ('Adidas', N'adidas@gmail.com')
insert into ThuongHieu(tenTH, emailTH)
values ('Nike', N'nike@gmail.com')
insert into ThuongHieu(tenTH, emailTH)
values ('Biti''s', N'bitis@gmail.com')
insert into ThuongHieu(tenTH, emailTH)
values ('POLO', N'polo@gmail.com')
insert into ThuongHieu(tenTH, emailTH)
values ('puma', N'puma@gmail.com')
insert into ThuongHieu(tenTH, emailTH)
values ('Gucci', N'Gucci@gmail.com')
