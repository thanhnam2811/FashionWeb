...
<div class="m-lr-auto bor10 p-lr-40 p-t-30 p-b-40 m-r-40 m-lr-0-xl p-lr-15-sm">
    <form action="editProduct" method="post">
        ...
        <div class="flex-w flex-t p-tb-34">
            ...
            <div class="size-101">
                <div class="bor8 bg0 size-101">
                    <input class="stext-111 cl2 plh3 size-111 p-lr-15" type="text" name="tenSP"
                           value="${SP.tenSP}">
                </div>
            </div>
        </div>
        ...
        <div class="flex-w flex-t p-t-1 p-b-33">
            ...
            <select class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9 size-101" name="maLoaiSP" sele>
                <c:forEach items="${listLoaiSP}" var="lsp">
                    <option value="${lsp.maLoaiSP}" ${lsp.maLoaiSP == SP.maLoaiSP ? "selected" : ""}>${lsp.tenLoaiSP}</option>
                </c:forEach>
            </select>
        </div>
        ...
        <div class="flex-w flex-t p-t-1 p-b-33">
            ...
            <select class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9 size-101" name="maTH">
        ...
        <div class="flex-w flex-t p-t-1 p-b-33">
            ...
            <div class="size-101">
                <div class="bor8 bg0 m-b-12">
                    <input class="stext-111 cl2 plh3 size-111 p-lr-15" type="text" name="hinhSP"
                           value="${SP.hinhSP}">
                </div>
            </div>
        </div>
        ...
        <div class="flex-w flex-t p-t-1 p-b-33">
            ...
            <div class="size-101">
                <div class="bor8 bg0 m-b-12">
                    <input class="stext-111 cl2 plh3 size-111 p-lr-15" type="number" name="giaSP"
                           value="${SP.giaSP}">
                </div>
            </div>
        </div>
        ...
        <div class="flex-w flex-t p-t-1 p-b-33">
            ...
            <div class="size-101">
                <div class="bor8 bg0 m-b-12">
                    <input class="stext-111 cl2 plh3 size-111 p-lr-15" type="number" name="soLuongSP"
                           value="${SP.soLuongSP}">
                </div>
            </div>
        </div>
            ...
            <div class="size-101">
                <div class="bor8 bg0 m-b-12">
                    <input class="stext-111 cl2 plh3 size-111 p-lr-15" type="date"
                           name="ngayDangBan" value="${SP.ngayDangBan}">
                </div>
            </div>
        </div>
